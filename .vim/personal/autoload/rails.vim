...
function! s:helpermethods()
  return ""
        ...
        \."button_to button_to_function buttons "
        ...
        \."image_path image_submit_tag image_tag input inputs "
        ...
        \."safe_concat sanitize sanitize_css search_field search_field_tag select select_date select_datetime select_day select_hour select_minute select_month select_second select_tag select_time select_year semantic_form_for semantic_fields_for simple_format sortable_element sortable_element_js strip_links strip_tags stylesheet_link_tag stylesheet_path submit_tag formtastic_stylesheet_link_tag "
